...
def create_balanced_image_dataset(parameters):

    # logging_info(f'Create balanced image dataset')
...
def build_balanced_image_dataset_ssd_pascal_voc(
    ...
    images_list = [i + ".jpg" for i in images_names_list]
    copy_images(input_dataset_type_folder, output_dataset_type_folder, images_list)
...
def build_balanced_image_dataset_yolo(
    ...
    images_names_list = balanced_image_dataset[dimension][input_dataset_type + '_images']
    images_list = [i + ".jpg" for i in images_names_list]
    copy_images(input_images_dataset_type_folder, output_images_dataset_type_folder, images_list)
    annotations_list = [i + ".txt" for i in images_names_list]
